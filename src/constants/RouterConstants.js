...
export const JOBS_BACKEND = {
  ...
  NOT_APPLIED_JOBS: process.env.NOT_APPLIED_JOBS,
  APPLY_JOB: process.env.APPLY_JOB,
  GET_JOBS_STATUS: process.env.GET_JOBS_STATUS,
  REFER_A_FRIEND: process.env.REFER_A_FRIEND,
  USER_PROFILE: process.env.USER_PROFILE,
  UPDATE_USER_PROFILE: process.env.UPDATE_USER_PROFILE,
  PROFILE_LOGOUT: process.env.PROFILE_LOGOUT,
  GET_CITIES: process.env.GET_CITIES,
  SAVE_PROFILE_DETAILS: process.env.SAVE_PROFILE_DETAILS,
}
